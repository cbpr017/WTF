...
@section('content')
	...
	<div class="container">
			...
			{!! Form::open(array('url' => 'employees', 'class' => 'form-inline newemp', 'style' => 'display:table;')) !!}
				...
				<label style="width:100px;">Hire Date:</label><input style="height:40px;margin:10px;" type="text" id="datepicker" name="hire_date"><br />
				<!-- <input style="height:40px;" type="file" name="attachment"> --><div id="datepicker"></div>
